...
//    }
    ...
    @PostMapping("start")
    public ResponseEntity<ResponseUtil> startParkingSession(@RequestBody int parkingId,int userId){
        System.out.println(parkingId);
        System.out.println(userId);

        try{
            boolean isSaved = parkingService.startParkingSession(parkingId,userId);
            if(isSaved){
                return ResponseEntity.status(HttpStatus.OK)
